    ...
    private synchronized void GetAvailableReader() {
        ...
        if (readers != null) {
            ...
            try {
                ...
                Log.e(TAG, "GetAvailableReader: InvalidUsageException " + ie.getVendorMessage());
            }
        }
    }
        ...
        public void eventReadNotify(RfidReadEvents e) {
            ...
            if (myTags != null) {
                ...
                for (TagData myTag : myTags) {
                    ...
                    if (myTag.getOpCode() == ACCESS_OPERATION_CODE.ACCESS_OPERATION_READ && myTag.getOpStatus() == ACCESS_OPERATION_STATUS.ACCESS_SUCCESS) {
